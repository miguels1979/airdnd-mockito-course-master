...
public class DataDummy {
    ...
    public static final BookingDto DEFAULT_BOOKING_REQ_3 = new BookingDto("48392392", LocalDate.of(2023,6,10),
            LocalDate.of(2023,6,26),2,false);

    public static final BookingDto DEFAULT_BOOKING_REQ_4 = new BookingDto("48392392", LocalDate.of(2023,6,10),
    LocalDate.of(2023,6,26),2,true);
